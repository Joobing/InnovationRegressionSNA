...
gen metascore_missing = ( metascore==. )
gen budget_missing = ( budget ==. )
recode metascore budget (.=0)
** label variables
...
label var metascore_missing "No metascore"
label var budget "Movie budget"
label var budget_missing "Unknown budget"
...
global cv_main  role_consolidation experience quality team_coreness team_quality average_confusion sequel metascore metascore_missing budget budget_missing 
...
* regressions
** direct effects
xtnbreg awards $cv_main $cv_genre $cv_role $cv_time , re
outreg2 using "Regressions.xls", dec(3) label alpha(.001, .01, .05, .1) symbol(***, **, *, +) e(all)
xtnbreg awards $cv_main $cv_genre $cv_role $cv_time brokerage_mc , re
outreg2 using "Regressions.xls", dec(3) label alpha(.001, .01, .05, .1) symbol(***, **, *, +) e(all)
xtnbreg awards $cv_main $cv_genre $cv_role $cv_time coreness_mc , re
outreg2 using "Regressions.xls", dec(3) label alpha(.001, .01, .05, .1) symbol(***, **, *, +) e(all)
xtnbreg awards $cv_main $cv_genre $cv_role $cv_time c.coreness_mc##c.coreness_mc , re
outreg2 using "Regressions.xls", dec(3) label alpha(.001, .01, .05, .1) symbol(***, **, *, +) e(all)
xtnbreg awards $cv_main $cv_genre $cv_role $cv_time focus_genres_mc , re
outreg2 using "Regressions.xls", dec(3) label alpha(.001, .01, .05, .1) symbol(***, **, *, +) e(all)
xtnbreg awards $cv_main $cv_genre $cv_role $cv_time focus_roles_mc , re
outreg2 using "Regressions.xls", dec(3) label alpha(.001, .01, .05, .1) symbol(***, **, *, +) e(all)
xtnbreg awards $cv_main $cv_genre $cv_role $cv_time focus_genres_mc focus_roles_mc , re difficult iter(250)
outreg2 using "Regressions.xls", dec(3) label alpha(.001, .01, .05, .1) symbol(***, **, *, +) e(all)
xtnbreg awards $cv_main $cv_genre $cv_role $cv_time focus_genres_mc focus_roles_mc brokerage_mc , re
outreg2 using "Regressions.xls", dec(3) label alpha(.001, .01, .05, .1) symbol(***, **, *, +) e(all)
xtnbreg awards $cv_main $cv_genre $cv_role $cv_time focus_genres_mc focus_roles_mc coreness_mc , re
outreg2 using "Regressions.xls", dec(3) label alpha(.001, .01, .05, .1) symbol(***, **, *, +) e(all)
xtnbreg awards $cv_main $cv_genre $cv_role $cv_time focus_genres_mc focus_roles_mc c.coreness_mc##c.coreness_mc , re iter(250)
outreg2 using "Regressions.xls", dec(3) label alpha(.001, .01, .05, .1) symbol(***, **, *, +) e(all)
xtnbreg awards $cv_main $cv_genre $cv_role $cv_time focus_genres_mc focus_roles_mc brokerage_mc coreness_mc , re
outreg2 using "Regressions.xls", dec(3) label alpha(.001, .01, .05, .1) symbol(***, **, *, +) e(all)
...
xtnbreg awards $cv_main $cv_genre $cv_role $cv_time focus_genres_mc focus_roles_mc brokerage_mc , re
outreg2 using "Interactions.xls", dec(3) label alpha(.001, .01, .05, .1) symbol(***, **, *, +) e(all)
xtnbreg awards $cv_main $cv_genre $cv_role $cv_time focus_genres_mc focus_roles_mc brokerage_mc c.focus_genres_mc#c.brokerage_mc , re
outreg2 using "Interactions.xls", dec(3) label alpha(.001, .01, .05, .1) symbol(***, **, *, +) e(all)
xtnbreg awards $cv_main $cv_genre $cv_role $cv_time focus_genres_mc focus_roles_mc brokerage_mc c.focus_roles_mc#c.brokerage_mc , re
outreg2 using "Interactions.xls", dec(3) label alpha(.001, .01, .05, .1) symbol(***, **, *, +) e(all)
xtnbreg awards $cv_main $cv_genre $cv_role $cv_time focus_genres_mc focus_roles_mc brokerage_mc c.focus_genres_mc#c.brokerage_mc c.focus_roles_mc#c.brokerage_mc , re
outreg2 using "Interactions.xls", dec(3) label alpha(.001, .01, .05, .1) symbol(***, **, *, +) e(all)
xtnbreg awards $cv_main $cv_genre $cv_role $cv_time focus_genres_mc focus_roles_mc c.coreness_mc##c.coreness_mc , re iter(250)
outreg2 using "Interactions.xls", dec(3) label alpha(.001, .01, .05, .1) symbol(***, **, *, +) e(all)
xtnbreg awards $cv_main $cv_genre $cv_role $cv_time focus_genres_mc focus_roles_mc c.coreness_mc##c.coreness_mc c.focus_genres_mc#c.coreness_mc##c.coreness_mc , re
outreg2 using "Interactions.xls", dec(3) label alpha(.001, .01, .05, .1) symbol(***, **, *, +) e(all)
xtnbreg awards $cv_main $cv_genre $cv_role $cv_time focus_genres_mc focus_roles_mc c.coreness_mc##c.coreness_mc c.focus_roles_mc#c.coreness_mc##c.coreness_mc , re
outreg2 using "Interactions.xls", dec(3) label alpha(.001, .01, .05, .1) symbol(***, **, *, +) e(all)
xtnbreg awards $cv_main $cv_genre $cv_role $cv_time focus_genres_mc focus_roles_mc c.coreness_mc##c.coreness_mc c.focus_genres_mc#c.coreness_mc##c.coreness_mc c.focus_roles_mc#c.coreness_mc##c.coreness_mc , re
outreg2 using "Interactions.xls", dec(3) label alpha(.001, .01, .05, .1) symbol(***, **, *, +) e(all)

* test for u-curve
** test 1: utest
gen coreness_mc_sq = coreness_mc*coreness_mc
xtnbreg awards $cv_main $cv_genre $cv_role $cv_time coreness_mc coreness_mc_sq , re 
...
// direction shift, but only at the very extremes
** test 4: split-sample
count if coreness_mc < $peak
count if coreness_mc > $peak
xtnbreg awards $cv_main $cv_genre $cv_role $cv_time coreness_mc if coreness_mc < $peak, re 
xtnbreg awards $cv_main $cv_genre $cv_role $cv_time coreness_mc if coreness_mc > $peak, re iter(250)
// does not converge: only .3% of observations beyond peak
** test 5: cube effect
gen coreness_mc_cu = coreness_mc*coreness_mc*coreness_mc
xtnbreg awards $cv_main $cv_genre $cv_role $cv_time coreness_mc coreness_mc_sq coreness_mc_cu , re iter(250)
// does not indicate an S-curve (but also does not converge)
