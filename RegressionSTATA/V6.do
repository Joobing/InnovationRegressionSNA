...
xtabond awards_logged $cv_main focus_genres_mc focus_roles_mc brokerage_mc if actor!=role_consolidation & producer!=role_consolidation 

xtabond awards 		  $cv_main focus_genres_mc focus_roles_mc brokerage_mc if actor!=role_consolidation & producer!=role_consolidation

*interactions not allowed: xtabond awards_logged   focus_roles_mc#brokerage_mc 

ssc install xtabond2

xtabond2 awards   c.focus_roles_mc#c.brokerage_mc , gmm(awards, lag(1 1) collapse eq(diff))      iv(tenure , eq(diff)) twostep robust
...
if actor!=role_consolidation & producer!=role_consolidation, re corr(ar)
