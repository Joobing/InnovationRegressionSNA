...
** group controls
global key_vars noms brokerage_mc coreness_mc focus_genres_mc focus_roles_mc 
...
** BASELINE ESTIMATION
eststo: xtnbreg noms $cv_main $cv_genre $cv_role $cv_time /// 
...
eststo: 
xtnbreg noms $cv_main $cv_genre $cv_role $cv_time ///
...
xtnbreg noms $cv_main $cv_genre $cv_role $cv_time coreness_mc coreness_mc_sq  if actor!=role_consolidation & producer!=role_consolidation, re

*centile (coreness_mc) if actor!=role_consolidation & producer!=role_consolidation, centile (0 1 5 95 99 100)
summ coreness, detail

utest coreness_mc coreness_mc_sq , prefix(noms)
// Extreme point:  17.47012 outside 99 percentile


** MARGINS
*** Full range
xtnbreg noms $cv_main $cv_genre $cv_role $cv_time c.coreness_mc##c.coreness_mc ///
if actor!=role_consolidation & producer!=role_consolidation, re
...
eststo: xtnbreg noms $cv_main $cv_genre $cv_role $cv_time c.coreness_mc ///
